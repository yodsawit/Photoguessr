...
/** Live bonus while playing: the % kept by the cards that are still hidden. */
export function BonusBadge({ pct }: { pct: number }) {
  return (
    <div className="flex h-12 items-center gap-1.5 rounded-2xl border border-butter bg-white/90 px-3 shadow-sm" aria-label={`Bonus plus ${pct} percent`}>
