...
2. Run `npm run upload -- --key <POOL_KEY> [--url https://<service>.onrender.com] <files...>`
...
3. Verify with the same pool key: `GET /api/rounds?count=20` lists the photo (id/width/height only) and
